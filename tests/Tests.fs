        ...
        testCase "testCase1" (fun _ ->
            ...
            let act =
                [
                    ...
                    "(case-insensitive), 'numberToWords' (case-insensitive), 'permissiveRoles'"
                    "(case-insensitive), 'removePermissiveRole' (case-insensitive), 'removeUserRole'"
                    "(case-insensitive), 'role' (case-insensitive), 'setTemplateRole'"
                    "(case-insensitive), 'updateUserRolesPermissions' (case-insensitive) or"
                    "'userRoles' (case-insensitive)"
                    ""
                ] |> String.concat "\r\n"
